...
<p >
<img class="one"src="men_img1.jpg"  width="100" height="140">
<h2>Model Number	6162SM01</h2>
<br>Leather watch.This watch is a Men's watch with 37.7 MM case diameter. The dial might appear smaller than what is seen on the Image. Please refer to the scale shot image (fourth image) to understand exact size of the watch.
...
<button class="button" name="cart" value="6162SM01">ADD TO CART</button>
</form>
</td>
<td>

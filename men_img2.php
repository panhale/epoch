...
<p>
<img class="one" src="men_img2.jpg"  width="100" height="140">
<h2>Model Number	6162SM11</h2>
Display Type: Analog, Movement Type: Quartz
Dial Color: Gold, Dial Shape: Round
Dial Material: Glass, Dial Glass Material: Metal
Band Color: Gold, Band Style: Strap
Warranty Type: Seller, Duration: 12 months, What's Covered ?: warranty Covers any manufacturing defetcs 
<br><br>
Band Colour	gold<br>
Band Material	Metal<br>
Band Width	30 Millimeters<br>
Battery Type	battery_type_9v<br>
...
<button class="button" name="cart" value="6162SM11">ADD TO CART</button>
</form>
</td>
<td>

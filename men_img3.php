...
<p>
<img class="one" src="men_img3.jpg"  width="100" height="140">
<h2>Model Number	7162SM11</h2>
Dial Color : Black<br>
Band Color : Black<br>
Watch Movement: Digital , Water Resistance Depth - 30 Meter , Sweat Resistant<br>
Case Material : Durable Tough Polybarbonate , Stainless Steel Back<br>
Features : Big Clear Display , Alarm , Stop Watch , Back Light , Date Day Display

<br><br>
Band Colour	black<br>
Band Material	Rubber<br>
Band Width	15 Centimeters<br>

Bezel Material	Plastic<br>
Brand	Skmei<br>
Case Diameter	37 Millimeters<br>
Case Material	Plastic, stainless steel
part Number  7162SM11<br>
...
<button class="button" name="cart" value="7162SM11">ADD TO CART</button>
</form>
</td>
<td>
